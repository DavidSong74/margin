...
export function TerracottaRefined() {
  ...
  return (
    <>
      ...
      <div 
        ...
        style={{ 
          background: 'radial-gradient(circle at center, #F5EFE4 0%, #F9F6F0 100%)',
          color: '#4A3B32' 
        }}
      >
        <div 
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {!isLogin && (
                <div className="space-y-1.5">
                  <label className="text-sm font-medium" style={{ color: '#8A7366' }}>Name (optional)</label>
                  <input
                    type="text"
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                    placeholder="Your name"
                    className="refined-input w-full px-4 py-3 rounded-lg outline-none transition-all"
                    style={{ 
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium" style={{ color: '#8A7366' }}>Email</label>
                <input
                  type="email"
                  value={email}
                  onChange={(e) => {
              ...
              <div className="space-y-1.5 relative">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-medium" style={{ color: '#8A7366' }}>Password</label>
                  {isLogin && (
                    <button type="button" className="text-sm font-medium hover:underline" style={{ color: '#C2714F' }}>
                      Forgot password?
                    </button>
                  )}
                </div>
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="refined-input w-full px-4 py-3 rounded-lg outline-none transition-all pr-12"
                    style={{ 
                      backgroundColor: '#FAF7F2', 
              ...
              {!isLogin && (
                <div className="space-y-1.5">
                  <label className="text-sm font-medium" style={{ color: '#8A7366' }}>Confirm password</label>
                  <input
                    type={showPassword ? "text" : "password"}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 rounded-xl font-semibold text-white flex justify-center items-center transition-all mt-6 shadow-sm hover:shadow-md disabled:opacity-70 active:scale-[0.98]"
                style={{ backgroundColor: '#C2714F' }}
                onMouseEnter={(e) => !isLoading && (e.currentTarget.style.backgroundColor = '#B5633F')}
                onMouseLeave={(e) => !isLoading && (e.currentTarget.style.backgroundColor = '#C2714F')}
              >
            ...
            <div className="flex items-center gap-4 my-8">
              ...
              <span className="text-xs italic" style={{ color: '#A67C68' }}>or</span>
              <div className="h-[1px] flex-1" style={{ backgroundColor: '#E3D5CA' }}></div>
            </div>
            ...
            <div className="mt-10 flex items-center justify-center text-sm whitespace-nowrap" style={{ color: '#8A7366' }}>
              ...
              <button 
                ...
                className="font-semibold hover:underline transition-colors ml-1"
                style={{ color: '#C2714F' }}
              >
